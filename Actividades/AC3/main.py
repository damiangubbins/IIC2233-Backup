...
class Jugador(Thread):
    ...
    def avanzar(self) -> None:
        ...
        cantidad_avanzar = randint(
            self.PORCENTAJE_MIN, self.PORCENTAJE_MAX) / 100
    ...
    def correr_segunda_mitad(self) -> bool | None:
        # Completar
        if self.lock_carrera.acquire(blocking=True):
...
if __name__ == "__main__":
    ...
    j1 = Jugador("Zelda", bandera, lock_bandera,
                 senal_inicio, senal_fin, lock_carrera)
    j2 = Jugador("Kirby", bandera, lock_bandera,
                 senal_inicio, senal_fin, lock_carrera)
    j3 = Jugador("Conan", bandera, lock_bandera,
                 senal_inicio, senal_fin, lock_carrera)
