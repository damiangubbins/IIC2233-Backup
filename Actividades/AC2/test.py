...
import funciones
from utilidades import Genero, Pelicula
...
class TestCargarDatos(unittest.TestCase):
    ...
    def test_cargar_peliculas_1(self):
        ...
        pelicula = Pelicula(20, 'The Social Network',
                            'David Fincher', 2010, 7.7)
    ...
    def test_cargar_peliculas_2(self):
        ...
        pelicula_3 = Pelicula(16, 'Interstellar',
                              'Christopher Nolan', 2014, 8.6)
        pelicula_4 = Pelicula(17, 'Gone with the Wind',
                              'Victor Fleming', 1939, 8.1)
        pelicula_5 = Pelicula(18, 'Casablanca', 'Michael Curtiz', 1942, 8.5)
        pelicula_6 = Pelicula(19, 'The Great Gatsby',
                              'Baz Luhrmann', 2013, 7.2)
    ...
    def test_cargar_peliculas_3(self):
        ...
        pelicula_3 = Pelicula(9, 'Schindler\'s List',
                              'Steven Spielberg', 1993, 8.9)
        self.assertSequenceEqual(lista_datos[0], pelicula_1)
        self.assertSequenceEqual(lista_datos[1], pelicula_2)
        self.assertSequenceEqual(lista_datos[2], pelicula_3)
    ...
    def test_cargar_peliculas_4(self):
        ...
        # Verificar resultados
        pelicula_2 = Pelicula(2, 'The Godfather',
                              'Francis Ford Coppola', 1972, 9.2)
        pelicula_13 = Pelicula(
            13, 'The Departed', 'Martin Scorsese', 2006, 8.5)
        self.assertSequenceEqual(lista_datos[1], pelicula_2)
...
class TestConsultas(unittest.TestCase):
    ...
    def test_obtener_directores_1(self):
        ...
        usa_metodo_prohibido(funciones.obtener_directores, [
                             'list', 'dict', 'set', 'tuple'])
    ...
    def test_obtener_directores_3(self):
        ...
        self.assertSequenceEqual(
            datos, {'Victor Fleming', 'Michael Curtiz', 'Baz Luhrmann'})
    ...
    def test_obtener_directores_4(self):
        ...
        self.assertIsInstance(datos, set)
        self.assertSequenceEqual(
            datos, {'Christopher Nolan', 'David Fincher', 'Lana Wachowski', 'Martin Scorsese'})
    ...
    def test_obtener_str_titulos_1(self):
        ...
        usa_metodo_prohibido(funciones.obtener_str_titulos, [
                             'list', 'dict', 'set', 'tuple'])
...
class TestFiltros(unittest.TestCase):
    ...
    def test_filtrar_peliculas_por_director(self):
        ...
        datos = funciones.filtrar_peliculas(
            self.generador_peliculas(2), director='Christopher Nolan')
        peliculas = [
        ...
        usa_metodo_prohibido(funciones.filtrar_peliculas, [
                             'list', 'dict', 'set', 'tuple'])
    ...
    def test_filtrar_peliculas_por_rating_min(self):
        ...
        datos = funciones.filtrar_peliculas(
            self.generador_peliculas(1), rating_min=8)
        peliculas = [
    ...
    def test_filtrar_peliculas_por_rating_max(self):
        ...
        datos = funciones.filtrar_peliculas(
            self.generador_peliculas(1), rating_max=7.7)
        peliculas = [
    ...
    def test_filtrar_peliculas_todo(self):
        ...
        datos = funciones.filtrar_peliculas(self.generador_peliculas(
            2), director='Martin Scorsese', rating_min=8.5, rating_max=9)
        peliculas = [
    ...
    def test_filtrar_peliculas_vacio(self):
        ...
        datos = funciones.filtrar_peliculas(self.generador_peliculas(
            1), director='Lana Wachowski', rating_min=8.5, rating_max=9)
        self.assertIsInstance(datos, filter)
    ...
    def test_filtrar_por_genero_1(self):
        ...
        datos = funciones.filtrar_peliculas_por_genero(
            self.generador_peliculas(1), self.generador_generos(1), 'Drama')
        resultado_esperado = [
            (Pelicula(5, 'Fight Club', 'David Fincher', 1999, 8.8), Genero('Drama', 5)),
            (Pelicula(20, 'The Social Network',
             'David Fincher', 2010, 7.7), Genero('Drama', 20))
        ]
        self.assertSequenceEqual(list(datos), resultado_esperado)

        # No usa for, while o loop
        usa_comando_prohibido(
            funciones.filtrar_peliculas_por_genero, ['for', 'while'])
        usa_metodo_prohibido(funciones.filtrar_peliculas_por_genero, [
                             'list', 'dict', 'set', 'tuple'])
    ...
    def test_filtrar_por_genero_2(self):
        ...
        datos = funciones.filtrar_peliculas_por_genero(
            self.generador_peliculas(2), self.generador_generos(2), 'Comedy')
        resultado_esperado = [
            (Pelicula(21, 'The Wolf of Wall Street',
             'Martin Scorsese', 2013, 8.2), Genero('Comedy', 21))
        ]
        self.assertSequenceEqual(list(datos), resultado_esperado)
    ...
    def test_filtrar_por_genero_none(self):
        ...
        datos = funciones.filtrar_peliculas_por_genero(
            self.generador_peliculas(2), self.generador_generos(3))
        resultado_esperado = [
            (Pelicula(4, 'The Dark Knight', 'Christopher Nolan',
             2008, 9.0), Genero('Action', 4)),
            (Pelicula(5, 'Fight Club', 'David Fincher', 1999, 8.8), Genero('Drama', 5)),
            (Pelicula(7, 'The Matrix', 'Lana Wachowski', 1999, 8.7), Genero('Sci-Fi', 7)),
            (Pelicula(8, 'Goodfellas', 'Martin Scorsese',
             1990, 8.7), Genero('Biography', 8))
        ]
        self.assertSequenceEqual(list(datos), resultado_esperado)
    ...
    def test_filtrar_por_genero_vacio_1(self):
        ...
        datos = funciones.filtrar_peliculas_por_genero(
            self.generador_peliculas(1), self.generador_generos(1), 'Comedy')
        self.assertSequenceEqual(list(datos), [])
    ...
    def test_filtrar_por_genero_vacio_2(self):
        ...
        datos = funciones.filtrar_peliculas_por_genero(
            self.generador_peliculas(3), self.generador_generos(3))
        self.assertSequenceEqual(list(datos), [])
...
class TestIterables(unittest.TestCase):
    ...
    def lista_peliculas(self, variacion):
        ...
        if variacion == 1:
            ...
            return [
                ...
                Pelicula(1, 'The Shawshank Redemption',
                         'Frank Darabont', 1994, 9.3),
            ...
            return [
                Pelicula(16, 'Interstellar', 'Christopher Nolan', 2014, 8.6),
                Pelicula(17, 'Gone with the Wind',
                         'Victor Fleming', 1939, 8.1),
    ...
    def test_IteradorDCCMax_next_1(self):
        ...
        dcc_max = funciones.IteradorDCCMax(lista_peliculas)
    ...
    def test_IteradorDCCMax_next_2(self):
        ...
        dcc_max = funciones.IteradorDCCMax(peliculas)
